...
// Client instance
var walletSmartAlert *gateway.Wallet = ReadWallet()

func ReadWallet() *gateway.Wallet {

	w, err := gateway.NewFileSystemWallet("/home/workspace/bitburket/DataGatewayLayer/fiber-mongo-api/packge/wallets")
	if err != nil {
...
func ReadContractSmartAlert() *gateway.Contract {
	...
	gw, err := gateway.Connect(
		...
		gateway.WithIdentity(walletSmartAlert, "Admin"),
	)
