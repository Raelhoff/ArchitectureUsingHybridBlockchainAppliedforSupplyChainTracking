...
==== Invoke assets ====
./minifab invoke -n smartcar -p '"CreateAsset","asset1","blue","5","tom","35"'
./minifab invoke -n smartcar -p '"CreateAsset","asset2","red","4","tom","50"'
./minifab invoke -n smartcar -p '"CreateAsset","asset3","blue","6","tom","70"'
./minifab invoke -n smartcar -p '"CreateAsset","asset4","blue","6","tom","70"'
...
./minifab invoke -n smartcar -p '"TransferAsset","asset2","jerry"'
./minifab invoke -n smartcar -p '"TransferAssetByColor","blue","jerry"'
./minifab invoke -n smartcar -p '"DeleteAsset","asset1"'
...
==== Query assets ====
./minifab query -n smartcar -p   '"ReadAsset","asset1"'
./minifab query -n smartcar -p   '"GetAssetsByRange","asset1","asset3"'
./minifab query -n smartcar -p   '"GetAssetHistory","asset1"'
...
./minifab query -n smartcar -p   '"QueryAssetsByOwner","tom"'
./minifab query -n smartcar -p   '"QueryAssets", "{\"selector\":{\"owner\":\"tom\"}}"'
./minifab query -n smartcar -p   '"QueryAssets", "{\"selector\":{\"color\":\"blue\"}}"'
...
Rich Query with Pagination (Only supported if CouchDB is used as state database):
 ./minifab query -n smartcar -p   '"QueryAssetsWithPagination", "{\"selector\":{\"owner\":\"tom\"}}","3",""'
...
./minifab query -n smartcar -p   '"QueryAssets", "{\"selector\":{\"docType\":{\"$eq\":\"asset\"},\"owner\":{\"$eq\":\"tom\"},\"size\":{\"$gt\":0}},\"fields\":[\"docType\",\"owner\",\"size\"],\"sort\":[{\"size\":\"desc\"}],\"use_index\":\"_design/indexSizeSortDoc\"}"'
*/
...
const index = "idDevice~name"

// DeviceChaincode implements the fabric-contract-api-go programming model
...
func (t *DeviceChaincode) CreateAsset(ctx contractapi.TransactionContextInterface, assetID, idDevice string, tipo string, productionDate string, productionLocation string, description string) error {
	...
	if err != nil {
		return fmt.Errorf("error json.Marshal")
	}

	err = ctx.GetStub().PutState(assetID, assetBytes)
	if err != nil {
		return fmt.Errorf("error PutState")
	}
	...
	colorNameIndexKey, err := ctx.GetStub().CreateCompositeKey(index, []string{asset.IdDevice, asset.ID})
	if err != nil {
		return fmt.Errorf("error GetStub")
	}
...
func (t *DeviceChaincode) ReadAsset(ctx contractapi.TransactionContextInterface, assetID string) (*Asset, error) {
...
func (t *DeviceChaincode) DeleteAsset(ctx contractapi.TransactionContextInterface, assetID string) error {
...
func (t *DeviceChaincode) TransferAsset(ctx contractapi.TransactionContextInterface, assetID, newType string) error {
	asset, err := t.ReadAsset(ctx, assetID)
	if err != nil {
		return err
	}
...
func (t *DeviceChaincode) GetAssetsByRange(ctx contractapi.TransactionContextInterface, startKey, endKey string) ([]*Asset, error) {
...
func (t *DeviceChaincode) TransferAssetByColor(ctx contractapi.TransactionContextInterface, idDevice, newType string) error {
	// Execute a key range query on all keys starting with 'color'
	coloredAssetResultsIterator, err := ctx.GetStub().GetStateByPartialCompositeKey(index, []string{idDevice})
	if err != nil {
		return err
	}
...
func (t *DeviceChaincode) QueryAssetsByIdDevice(ctx contractapi.TransactionContextInterface, idDevice string) ([]*Asset, error) {
	queryString := fmt.Sprintf(`{"selector":{"docType":"asset","idDevice":"%s"}}`, idDevice)
...
func (t *DeviceChaincode) QueryAssets(ctx contractapi.TransactionContextInterface, queryString string) ([]*Asset, error) {
	return getQueryResultForQueryString(ctx, queryString)
}
...
func (t *DeviceChaincode) GetAssetsByRangeWithPagination(ctx contractapi.TransactionContextInterface, startKey string, endKey string, pageSize int, bookmark string) ([]*Asset, error) {
...
func (t *DeviceChaincode) QueryAssetsWithPagination(ctx contractapi.TransactionContextInterface, queryString string, pageSize int, bookmark string) (*PaginatedQueryResult, error) {
...
func (t *DeviceChaincode) GetAssetHistory(ctx contractapi.TransactionContextInterface, assetID string) ([]HistoryQueryResult, error) {
...
func (t *DeviceChaincode) AssetExists(ctx contractapi.TransactionContextInterface, assetID string) (bool, error) {
	assetBytes, err := ctx.GetStub().GetState(assetID)
	if err != nil {
...
func (t *DeviceChaincode) InitLedger(ctx contractapi.TransactionContextInterface) error {
	assets := []Asset{
		{DocType: "asset", ID: "asset1", IdDevice: "1234", Type: "---", ProductionLocation: "Tomoko", ProductionDate: "2023"},
	}

	for _, asset := range assets {
		err := t.CreateAsset(ctx, asset.ID, asset.IdDevice, asset.Type, asset.ProductionLocation, asset.ProductionDate)
		if err != nil {
			return err
		}
	}
...
func main() {
	chaincode, err := contractapi.NewChaincode(&DeviceChaincode{})
	if err != nil {
